...
nba_player.points= nba_player.points.map {|var| var.to_i}
nba_player.assists= nba_player.assists.map{|var| var.to_i}
nba_player.rebounds= nba_player.rebounds.map{|var| var.to_i}
nba_player.true_shooting= nba_player.true_shooting.map{|var| var.to_f}
per_game_array.length.times do |i|
  if i>(per_game_array.length-11)
