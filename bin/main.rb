...
ppg = nba_player.averages(nba_player.points)
ast = nba_player.averages(nba_player.assists)
reb = nba_player.averages(nba_player.rebounds)
fg = nba_player.averages(nba_player.true_shooting)
latest_ppg = nba_player.averages(nba_player.last_ten_points)
latest_ast = nba_player.averages(nba_player.last_ten_assists)
latest_reb = nba_player.averages(nba_player.last_ten_rebounds)
latest_fg = nba_player.averages(nba_player.last_ten_shooting)
